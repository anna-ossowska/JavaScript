...
// Finish writing a function addFriend so that it takes a user object and adds
// the name of the friend argument to the array stored in user.data.friends and returns that array.
