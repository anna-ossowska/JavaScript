...
// Note that the rating values are saved as strings in the object and you may need to convert them into numbers
...
var filteredList = watchList.filter(movie => movie["imdbRating"] >= 8.0).map(movie => ({
  title: movie["Title"],
