...
// // we want cidObj["ONE HUNDRED"] to exists, hence the second condition
// if (amountToPay >= moneyObj["ONE HUNDRED"] && cidObj["ONE HUNDRED"]) {
//   if (amountToPay >= cidObj["ONE HUNDRED"]) {
//     const amountToSubtract = cidObj["ONE HUNDRED"];
//     amountToPay -= amountToSubtract;
//     changeToGive.push(["ONE HUNDRED", amountToSubtract / 100]);
//     cidObj["ONE HUNDRED"] = 0;
//   } else {
//     const amountToSubtract = Math.floor(amountToPay / moneyObj["ONE HUNDRED"]) * moneyObj["ONE HUNDRED"];
//     amountToPay -= amountToSubtract;
//     changeToGive.push(["ONE HUNDRED", amountToSubtract / 100]);
//     cidObj["ONE HUNDRED"] -= amountToSubtract;
//   }
// }